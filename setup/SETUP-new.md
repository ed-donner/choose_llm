...
`git clone https://github.com/ed-donner/choose_lm.git`

This creates a new directory `choose_lm` within your projects folder and downloads the code for the class.  
Do `cd choose_lm` to go into it. This `choose_lm` directory is known as the "project root directory".
...
Find your choose_lm directory within your projects directory. Double click on choose_lm so you're looking at the contents of choose_lm. Then click Open or Open Folder.

Cursor should then open up choose_lm. You know you're in good shape if you see CHOOSE_LLM in block caps on the top left.
...
Find your choose_lm directory within your projects directory. Double click on choose_lm so you're looking at the contents of choose_lm. Then click Open.
...
If you're wondering why I rant about this: I get many, many frustrated people contacting me who (despite all my appeals) have named the file something else and think it's OK. It's not OK! It needs to be called `.env` in the choose_lm directory 😂
